...
let package = Package(
    ...
    targets: [
        ...
        // macOS Accessibility: reading a browser window as semantics rather
        // than pixels. Separate from ScreenCapture because it reads structure.
        // Read-only — it drives nothing, and there is no CDP target beside it
        // any more.
        .target(
            name: "BrowserAX",
            dependencies: [],
