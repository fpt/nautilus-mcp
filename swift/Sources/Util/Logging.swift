...
public struct Logger {
    ...
    private func log(_ level: LogLevel, _ message: String) {
        ...
        // Always stderr, every level. stdout belongs to whatever protocol the
        // process speaks — for nautilus-mcp that is the MCP stream itself, and
        // a stray log line there corrupts it.
        fputs(output + "\n", stderr)
    }
